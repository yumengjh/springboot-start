...
@Service public class AuditService {
 ...
 @Transactional public void event(String action,String targetType,String targetId){events.save(new AuditEvent(action,targetType,targetId,MDC.get(TraceIdFilter.TRACE_ID_MDC_KEY),null));}
